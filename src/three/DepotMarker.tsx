  ...
  return (
    <group position={pos}>
      ...
      <mesh position={[0, 0.13, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#33373c" roughness={0.85} metalness={0.2} />
      </mesh>
      {/* 着陆白环 */}
      ...
      <group position={[5.5, 0, 0]}>
        ...
        <mesh position={[0, 2.6, 0]} castShadow>
          ...
          <meshStandardMaterial color="#b9c2c8" roughness={0.5} metalness={0.4} />
        </mesh>
        {/* 漏斗 */}
        ...
        <mesh position={[0, 4.7, 0]} castShadow>
          ...
          <meshStandardMaterial color="#8a949b" roughness={0.6} metalness={0.3} />
        </mesh>
        {/* 四条支腿 */}
        {[45, 135, 225, 315].map((deg) => {
          ...
          return (
            <mesh key={deg} position={[Math.cos(a) * 1.2, 1.1, Math.sin(a) * 1.2]} castShadow>
              ...
              <meshStandardMaterial color="#6b7177" roughness={0.7} metalness={0.3} />
            </mesh>
          );
        })}
      </group>
